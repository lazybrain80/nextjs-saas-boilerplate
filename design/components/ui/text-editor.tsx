...
const MenuBar = () => {
  ...
  return (
    <div className="flex flex-wrap items-center p-2 rounded-lg shadow-md bg-opacity-90 backdrop-blur-sm">
      <MenuButton
    ...
    <div className={cn(className)}>
      <EditorProvider
        editorProps={{
          attributes: {
            class:
              'prose sm:prose-sm lg:prose-lg xl:prose-2xl mt-2 p-4 max-w-full min-h-[12.5rem] rounded-lg border border-gray-200 dark:border-gray-700 focus:outline-none',
          },
        }}
