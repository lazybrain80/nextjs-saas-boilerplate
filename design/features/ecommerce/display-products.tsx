...
import { Card, Button, Transition } from '@/design/components'
        ...
        {(cachedItems as BaseEcommerceProduct[]).map(product => (
          ...
          >
            <Link href={`/apps/ecommerce/${product.id}`}>
              <Transition className="relative pb-[100%] group" durationIn={Math.random() * 5}>
                <Image
                  ...
                  height={256}
                />
                <Button className="absolute top-2 right-2 p-2 bg-white rounded-full shadow hover:bg-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
