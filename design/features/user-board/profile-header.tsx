...
export const ProfileHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  ...
  <Card className={cn(className)}>
    <CardHeader
      className='relative h-96 bg-[url(/images/profile/header-bg.png)] bg-cover bg-no-repeat'
    >
      <div
        className={cn(
    ...
    <CardContent
      className='relative h-48 bg-white rounded-2xl shadow-xl p-4'
    >
      <div className='flex justify-between items-center'>
        <div>
          <div className='flex items-center'>
            <CardTitle className='text-2xl'>{user.preferred_username}</CardTitle>
        ...
        <div className='flex items-center'>
          <Button className='bg-transparent hover:bg-gray-100'>
            <div
              className='bg-black border-2 rounded-full border-black'
            >
              <Icons.TwitterX />
            </div>
          </Button>
          <Button className='text-gray-500 text-sm bg-transparent hover:bg-gray-100'>
            <div
              className='bg-blue-50 border-2 rounded-full border-blue-600'
            >
              <Icons.Meta />
            </div>
          </Button>
          <Button className='text-gray-500 text-sm bg-transparent hover:bg-gray-100'>
            <div
              className='bg-yellow-50 border-2 rounded-full border-yellow-600'
            >
              <Icons.Google/>
            </div>
          </Button>
          <Button className='text-gray-500 text-sm bg-transparent hover:bg-gray-100'>
            <div
              className='bg-blue-500 border-2 rounded-full border-blue-500'
            >
            <Icons.LinkedIn />
            </div>
          </Button>
          ...
          <Button className='text-gray-500 text-sm bg-transparent hover:bg-gray-100'>
            <div
              className='bg-red-500 border-2 rounded-full border-red-500'
            >
              <Icons.Youtube />
            </div>
          </Button>
          <Button
            className='bg-blue-500 rounded-full w-36 ml-6'
          >
            Edit Profile
          </Button>
        </div>
