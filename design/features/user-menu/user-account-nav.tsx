    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align='end' className='rounded-2xl p-4'>
        ...
        >
          <div className='flex'>
            <div
              className='flex items-center rounded-xl bg-blue-100 size-10 mr-4'
            >
              <Icons.User
                className='m-auto text-sky-500'
              />
            </div>
            <Link
        ...
        >
          <Button
            className='m-auto bg-blue-500 w-72 hover:bg-blue-700 rounded-3xl'
          >
            {t('sign_out')}
          </Button>
        </DropdownMenuItem>
