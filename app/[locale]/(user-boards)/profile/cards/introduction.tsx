...
export const IntroductionCard = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  ...
  <Card className={cn(className)}>
    ...
    <CardHeader>
      ...
      >
        <div
          className='bg-red-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.Phone
      ...
      >
        <div
          className='bg-green-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.Mail
      ...
      >
        <div
          className='bg-pink-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.Instagram
        ...
        <div className='ml-4'>
          ...
          <div className='text-slate-500'>@{user.preferred_username}</div>
        </div>
      </div>
    </CardHeader>
    ...
    <CardHeader>
      ...
      >
        <div
          className='bg-blue-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.MapPin
      ...
      >
        <div
          className='bg-amber-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.GraduationCap
      ...
      >
        <div
          className='bg-slate-100 rounded-full h-12 w-12 flex items-center justify-center'
        >
          <Icons.Languages
